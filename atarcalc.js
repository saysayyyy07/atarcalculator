...
const rawmarksInput = document.querySelector(".rawmarksInput")
...
const subjectOptions = {
    "mathsstd": "Maths (Standard)",
    "mathsadv": "Maths (Advanced)",
    "mathsext1": "Maths Ext 1",
    "mathsext2": "Maths Ext 2",
    "biology": "Biology",
    "chemistry": "Chemistry",
    "physics": "Physics",
    "englishstd": "English (Standard)",
    "englishadv": "English (Advanced)",
    "englishext1": "English Ext 1",
    "englishext2": "English Ext 2",
    "economics": "Economics",
    "business": "Business Studies",
    "legal": "Legal Studies",
    "modernhis": "Modern History",
    "ancienthis": "Ancient History",
    "sdd": "SDD",
...
function advancedCalculations(subNum) {
    ...
    if (subName == "mathsstd") {
        ...
        else aligned[subName] = 12*subWAM/7;
        ...
        if (subWAM >= 79) aligned[subName] = (10*subWAM + 1100)/21;
        else if (subWAM >= 60) aligned[subName] = 8*subWAM/15 + 48;
        else if (subWAM >= 41) aligned[subName] = (subWAM/2 + 99/2);
        ...
        if (aligned[subName]/2 >= 39) scaled[subName] = 2.14286*aligned[subName]/2 - 56.0714;
        ...
        else aligned[subName] = 1.206636501*subWAM;
...
function displayScaled(subNum, subName) {
    ...
    scaledHTML[0].innerHTML = "Scaled: " + Math.round(scaled[subName]);
}
